...
final ThemeData lightTheme = appTheme.copyWith(
  ...
  dividerTheme: const DividerThemeData(thickness: 1, color: Color(0xFFF5F5F5)),
  ...
  tabBarTheme: TabBarThemeData(
    ...
    indicator: UnderlineTabIndicator(
      borderSide: BorderSide(width: 2.5, color: colorLightScheme.primary),
    ),
  ),
...
final ThemeData darkTheme = appTheme.copyWith(
  extensions: <ThemeExtension<dynamic>>[ThemeTextStyles.dark, ThemeColors.dark],
  bottomSheetTheme: const BottomSheetThemeData(
    elevation: 0,
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.only(
